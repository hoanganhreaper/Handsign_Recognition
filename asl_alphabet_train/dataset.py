...
class ASLDataset(Dataset):
    def __init__(self, 
        ...
        self.class_names, self.class_to_idx = utils.get_class(data_path)
    ...
    def __getitem__(self, idx):
        ...
        # Handle the last index gracefully
        next_idx = (idx + 1) % len(self.img_path)
        img2 = self.load_image(next_idx)
